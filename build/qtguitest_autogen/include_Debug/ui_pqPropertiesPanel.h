...
public:
    ...
    void setupUi(QWidget *propertiesPanel)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqApply.svg"), QSize(), QIcon::Normal, QIcon::Off);
        Accept->setIcon(icon);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqCancel.svg"), QSize(), QIcon::Normal, QIcon::Off);
        Reset->setIcon(icon1);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/QtWidgets/Icons/pqDelete.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqHelp.svg"), QSize(), QIcon::Normal, QIcon::Off);
        Help->setIcon(icon3);
        ...
        PropertiesCopy->setObjectName(QString::fromUtf8("PropertiesCopy"));
        PropertiesCopy->setEnabled(false);
        PropertiesCopy->setMaximumSize(QSize(50, 16777215));
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqCopy.svg"), QSize(), QIcon::Normal, QIcon::Off);
        PropertiesCopy->setIcon(icon4);

        horizontalLayout->addWidget(PropertiesCopy);

        PropertiesPaste = new QPushButton(PropertiesButtons);
        PropertiesPaste->setObjectName(QString::fromUtf8("PropertiesPaste"));
        PropertiesPaste->setEnabled(false);
        PropertiesPaste->setMaximumSize(QSize(50, 16777215));
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqPaste.svg"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/pqWidgets/Icons/pqReset.svg"), QSize(), QIcon::Normal, QIcon::Off);
        PropertiesRestoreDefaults->setIcon(icon6);
        ...
        DisplayCopy->setObjectName(QString::fromUtf8("DisplayCopy"));
        ...
        DisplayPaste->setObjectName(QString::fromUtf8("DisplayPaste"));
        ...
        DisplayRestoreDefaults->setIcon(icon6);
        ...
        ViewCopy->setObjectName(QString::fromUtf8("ViewCopy"));
        ...
        ViewPaste->setObjectName(QString::fromUtf8("ViewPaste"));
        ...
        ViewRestoreDefaults->setIcon(icon6);
    ...
    {
        propertiesPanel->setWindowTitle(QCoreApplication::translate("propertiesPanel", "Properties Panel", nullptr));
        Accept->setText(QCoreApplication::translate("propertiesPanel", "Apply", nullptr));
#if QT_CONFIG(tooltip)
        Reset->setToolTip(QCoreApplication::translate("propertiesPanel", "Resets any changed properties to their values from the last time 'Apply' was clicked.", nullptr));
#endif // QT_CONFIG(tooltip)
        Reset->setText(QCoreApplication::translate("propertiesPanel", "Reset", nullptr));
        Delete->setText(QCoreApplication::translate("propertiesPanel", "Delete", nullptr));
        Help->setText(QString());
#if QT_CONFIG(shortcut)
        Help->setShortcut(QCoreApplication::translate("propertiesPanel", "Ctrl+H", nullptr));
#endif // QT_CONFIG(shortcut)
        PropertiesButton->setProperty("text", QVariant(QCoreApplication::translate("propertiesPanel", "Properties", nullptr)));
#if QT_CONFIG(tooltip)
        PropertiesCopy->setToolTip(QCoreApplication::translate("propertiesPanel", "Copy properties", nullptr));
#endif // QT_CONFIG(tooltip)
        PropertiesCopy->setText(QString());
#if QT_CONFIG(tooltip)
        PropertiesPaste->setToolTip(QCoreApplication::translate("propertiesPanel", "Paste copied properties", nullptr));
#endif // QT_CONFIG(tooltip)
        PropertiesPaste->setText(QString());
#if QT_CONFIG(tooltip)
        PropertiesRestoreDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Restore application default setting values", nullptr));
#endif // QT_CONFIG(tooltip)
        PropertiesRestoreDefaults->setText(QString());
#if QT_CONFIG(tooltip)
        PropertiesSaveAsDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Save current settings values as default", nullptr));
#endif // QT_CONFIG(tooltip)
        PropertiesSaveAsDefaults->setText(QString());
        DisplayButton->setProperty("text", QVariant(QCoreApplication::translate("propertiesPanel", "Display", nullptr)));
#if QT_CONFIG(tooltip)
        DisplayCopy->setToolTip(QCoreApplication::translate("propertiesPanel", "Copy display properties", nullptr));
#endif // QT_CONFIG(tooltip)
        DisplayCopy->setText(QString());
#if QT_CONFIG(tooltip)
        DisplayPaste->setToolTip(QCoreApplication::translate("propertiesPanel", "Paste copied display properties", nullptr));
#endif // QT_CONFIG(tooltip)
        DisplayPaste->setText(QString());
#if QT_CONFIG(tooltip)
        DisplayRestoreDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Restore application default setting values for display", nullptr));
#endif // QT_CONFIG(tooltip)
        DisplayRestoreDefaults->setText(QString());
#if QT_CONFIG(tooltip)
        DisplaySaveAsDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Save current display settings values as default", nullptr));
#endif // QT_CONFIG(tooltip)
        DisplaySaveAsDefaults->setText(QString());
        ViewButton->setProperty("text", QVariant(QCoreApplication::translate("propertiesPanel", "View", nullptr)));
#if QT_CONFIG(tooltip)
        ViewCopy->setToolTip(QCoreApplication::translate("propertiesPanel", "Copy view properties", nullptr));
#endif // QT_CONFIG(tooltip)
        ViewCopy->setText(QString());
#if QT_CONFIG(tooltip)
        ViewPaste->setToolTip(QCoreApplication::translate("propertiesPanel", "Paste view properties", nullptr));
#endif // QT_CONFIG(tooltip)
        ViewPaste->setText(QString());
#if QT_CONFIG(tooltip)
        ViewRestoreDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Restore application default setting values for view", nullptr));
#endif // QT_CONFIG(tooltip)
        ViewRestoreDefaults->setText(QString());
#if QT_CONFIG(tooltip)
        ViewSaveAsDefaults->setToolTip(QCoreApplication::translate("propertiesPanel", "Save current view settings values as default", nullptr));
#endif // QT_CONFIG(tooltip)
