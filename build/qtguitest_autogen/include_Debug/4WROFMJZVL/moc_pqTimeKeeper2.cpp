/****************************************************************************
** Meta object code from reading C++ file 'pqTimeKeeper2.h'
**
...
#include <memory>
#include "../../../../Qt/Core/pqTimeKeeper2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pqTimeKeeper2.h' doesn't include <QObject>."
...
void pqTimeKeeper::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqTimeKeeper *>(_o);
        (void)_t;
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject pqTimeKeeper::staticMetaObject = { {
    QMetaObject::SuperData::link<pqProxy::staticMetaObject>(),
    qt_meta_stringdata_pqTimeKeeper.data,
    qt_meta_data_pqTimeKeeper,
    qt_static_metacall,
    nullptr,
    nullptr
} };
