/****************************************************************************
** Meta object code from reading C++ file 'pqRepresentation2.h'
**
...
#include <memory>
#include "../../../../Qt/Core/pqRepresentation2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pqRepresentation2.h' doesn't include <QObject>."
...
void pqRepresentation::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqRepresentation *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (pqRepresentation::*)(bool );
        ...
        {
            using _t = void (pqRepresentation::*)();
...
QT_INIT_METAOBJECT const QMetaObject pqRepresentation::staticMetaObject = { {
    QMetaObject::SuperData::link<pqProxy::staticMetaObject>(),
    qt_meta_stringdata_pqRepresentation.data,
    qt_meta_data_pqRepresentation,
    qt_static_metacall,
    nullptr,
    nullptr
} };
