/****************************************************************************
** Meta object code from reading C++ file 'pqProxy2.h'
**
...
#include <memory>
#include "../../../../Qt/Core/pqProxy2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pqProxy2.h' doesn't include <QObject>."
...
void pqProxy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqProxy *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (pqProxy::*)(pqServerManagerModelItem * );
...
QT_INIT_METAOBJECT const QMetaObject pqProxy::staticMetaObject = { {
    QMetaObject::SuperData::link<pqServerManagerModelItem::staticMetaObject>(),
    qt_meta_stringdata_pqProxy.data,
    qt_meta_data_pqProxy,
    qt_static_metacall,
    nullptr,
    nullptr
} };
