...
QT_MOC_LITERAL(11, 105, 6), // "prompt"
...
QT_MOC_LITERAL(13, 129, 9) // "takeFocus"
    ...
    "printCommand\0cmd\0text\0clear\0prompt\0"
...
void pqConsoleWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqConsoleWidget *>(_o);
        (void)_t;
        switch (_id) {
        ...
        case 6: _t->prompt((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 7: _t->insertCompletion((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 8: _t->takeFocus(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (pqConsoleWidget::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject pqConsoleWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_pqConsoleWidget.data,
    qt_meta_data_pqConsoleWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
