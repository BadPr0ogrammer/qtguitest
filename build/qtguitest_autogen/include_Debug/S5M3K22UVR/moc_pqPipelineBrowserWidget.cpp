...
QT_MOC_LITERAL(3, 35, 18), // "handleIndexClicked"
QT_MOC_LITERAL(4, 54, 11), // "QModelIndex"
QT_MOC_LITERAL(5, 66, 5), // "index"
QT_MOC_LITERAL(6, 72, 31) // "expandWithModelIndexTranslation"

    },
    "pqPipelineBrowserWidget\0deleteKey\0\0"
    "handleIndexClicked\0QModelIndex\0index\0"
...
void pqPipelineBrowserWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqPipelineBrowserWidget *>(_o);
        (void)_t;
        switch (_id) {
        case 0: _t->deleteKey(); break;
        case 1: _t->handleIndexClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 2: _t->expandWithModelIndexTranslation((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (pqPipelineBrowserWidget::*)();
...
QT_INIT_METAOBJECT const QMetaObject pqPipelineBrowserWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<pqFlatTreeView::staticMetaObject>(),
    qt_meta_stringdata_pqPipelineBrowserWidget.data,
    qt_meta_data_pqPipelineBrowserWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
