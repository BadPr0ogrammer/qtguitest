...
void pqPythonShell::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqPythonShell *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (pqPythonShell::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject pqPythonShell::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_pqPythonShell.data,
    qt_meta_data_pqPythonShell,
    qt_static_metacall,
    nullptr,
    nullptr
} };
