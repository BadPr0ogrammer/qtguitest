/****************************************************************************
** Meta object code from reading C++ file 'pqPythonMacroSupervisor2.h'
**
...
#include <memory>
#include "../../../../Qt/Python/pqPythonMacroSupervisor2.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'pqPythonMacroSupervisor2.h' doesn't include <QObject>."
...
void pqPythonMacroSupervisor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<pqPythonMacroSupervisor *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (pqPythonMacroSupervisor::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject pqPythonMacroSupervisor::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_pqPythonMacroSupervisor.data,
    qt_meta_data_pqPythonMacroSupervisor,
    qt_static_metacall,
    nullptr,
    nullptr
} };
