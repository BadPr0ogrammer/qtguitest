...
// b #include "vtkVariant.h"                     // for vtkVariant
...
private:
  ...
  union {
    ...
    // b vtkSMVectorProperty* VectorProperty;
    // b vtkSMIntVectorProperty* IntVectorProperty;
    // b vtkSMDoubleVectorProperty* DoubleVectorProperty;
    // b vtkSMIdTypeVectorProperty* IdTypeVectorProperty;
    // b vtkSMStringVectorProperty* StringVectorProperty;
    vtkSMProxyProperty* ProxyProperty;
    // b vtkSMInputProperty* InputProperty;
  };
};
