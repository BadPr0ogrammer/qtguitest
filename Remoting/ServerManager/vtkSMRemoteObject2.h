...
/* b
#include "vtkSMMessageMinimal2.h"            // needed for vtkSMMessage
...
{
  // My friends are...
  // b friend class vtkSMStateHelper; // To pull state
  // b friend class vtkSMStateLoader; // To set GlobalId as the originals
...
public:
   ...
   */
  // b void SetSession(vtkSMSession*) override;
   ...
   */
  // b virtual const vtkSMMessage* GetFullState() { return nullptr; }
...
protected:
   ...
   */
  // b void PushState(vtkSMMessage* msg);
   ...
   */
  // b bool PullState(vtkSMMessage* msg);
...
class VTKREMOTINGSERVERMANAGER_EXPORT SIOBJECT
{
  ...
  //b friend VTKREMOTINGSERVERMANAGER_EXPORT vtkClientServerStream& operator<<(vtkClientServerStream& stream, const SIOBJECT& manipulator);
...
// b VTKREMOTINGSERVERMANAGER_EXPORT vtkClientServerStream& operator<<(vtkClientServerStream& stream, const SIOBJECT& manipulator);
