...
#include "vtkSMProperty2.h"      // for vtkSMProperty
// b #include "vtkSMPropertyGroup2.h" // for vtkSMPropertyGroup
#include "vtkSMProxy2.h"         // for vtkSMProxy
// b #include "vtkSMProxyLink.h"     // for vtkSMProxyLink
...
struct vtkSMProxyInternals
{
  ...
  // b std::vector<vtkSmartPointer<vtkSMPropertyGroup>> PropertyGroups;
  ...
  // b typedef std::vector<vtkSmartPointer<vtkSMProxyLink>> SubProxyLinksType;
  // b SubProxyLinksType SubProxyLinks;
