...
/* b
#include "vtkSMDomain2.h"
#include "vtkSMDomainIterator2.h"
#include "vtkSMMessage2.h"
#include "vtkSMProxyProperty2.h"
#include "vtkClientServerStream2.h"
#include "vtkClientServerStreamInstantiator2.h"
#include "vtkSMPropertyLink2.h"
...
// b #include "vtkSMPropertyInternals2.h"
...
vtkSMProperty::vtkSMProperty()
{
  ...
  // b this->PInternals = new vtkSMPropertyInternals;
  ...
  // b this->DomainIterator = vtkSMDomainIterator::New();
  // b this->DomainIterator->SetProperty(this);
  this->Proxy = nullptr;
  this->InformationOnly = 0;
  this->InformationProperty = nullptr;
  this->IsInternal = 0;
  this->NoCustomDefault = 0;
  // b this->Documentation = nullptr;
  this->Repeatable = 0;
  this->IgnoreSynchronization = 0;
  // b this->Links = nullptr;
  ...
  // dependent domains.
  // b this->AddObserver(vtkCommand::UncheckedPropertyModifiedEvent, this, &vtkSMProperty::UpdateDomains);
}

//---------------------------------------------------------------------------
vtkSMProperty::~vtkSMProperty()
{
  // b this->RemoveFromSourceLink();
  this->SetCommand(nullptr);
  // b delete this->PInternals;
  this->SetXMLName(nullptr);
  this->SetXMLLabel(nullptr);
  // b this->DomainIterator->Delete();
  // b this->SetInformationProperty(nullptr);
  // b this->SetDocumentation(nullptr);
  // b this->SetHints(nullptr);
  // b this->SetParent(nullptr);
