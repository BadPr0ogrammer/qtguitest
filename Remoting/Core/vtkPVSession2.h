...
public:
   ...
   */
  // b virtual vtkMultiProcessController* GetController(ServerFlags processType);

  /**
   * This is socket connection, if any to communicate between the data-server
   * and render-server nodes.
   */
  // b virtual vtkMPIMToNSocketConnection* GetMPIMToNSocketConnection() { return nullptr; }
   ...
   */
  // b virtual vtkPVServerInformation* GetServerInformation() = 0;
   ...
   */
  // b vtkGetObjectMacro(ProgressHandler, vtkPVProgressHandler);
  //@}
...
protected:
  ...
  // b virtual void CleanupPendingProgressInternal();
  //@}

  // b vtkPVProgressHandler* ProgressHandler;
