...
public:
  ...
  pqProxy(const QString& group, const QString& name, vtkSMProxy* proxy, 
      // b pqServer* server,
   ...
   */
  // b vtkSMSessionProxyManager* proxyManager() const;
...
private:
  // b QPointer<pqServer> Server; ///< Stores the parent server.
  QString SMName;
  QString SMGroup;
