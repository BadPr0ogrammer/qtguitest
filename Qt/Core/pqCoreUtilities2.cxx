...
{
  // b pqSettings* settings = pqApplicationCore::instance()->settings();
  // b return QFileInfo(settings->fileName()).path();
    return QString();
}
  ...
  */
  ...
  switch (mbox.standardButton(mbox.clickedButton()))
  {
    case QMessageBox::Save:
      // b settings->setValue(settingsKey, true);
      return true;
...
QString pqCoreUtilities::number(double value)
{
  ...
  // b stream << vtkNumberToString()(value);
