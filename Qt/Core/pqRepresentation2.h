...
public:
  ...
  pqRepresentation(const QString& group, const QString& name, vtkSMProxy* repr, 
      // b pqServer* server,
   ...
   */
  // b virtual bool isVisible() const;
