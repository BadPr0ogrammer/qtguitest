...
#include "pqPipelineFilter2.h"
#include "pqSMAdaptor2.h"
#include "pqServer2.h"
#include "pqUndoStack2.h"
#include "pqXMLUtil2.h"
*/
//-----------------------------------------------------------------------------
...
public:
  ...
  // b QList<vtkSmartPointer<vtkSMPropertyLink>> Links;
...
{
  // b Q_EMIT this->visibilityChanged(this, qobject_cast<pqDataRepresentation*>(this->sender()));
}
/* b
//-----------------------------------------------------------------------------
