...
public:
   ...
   */
  // b void enableSessionFilter(vtkSession* session);
   ...
   */
  // b void setModel(pqPipelineModel* model);
  ...
  // b const pqPipelineModel* getPipelineModel(const QModelIndex& index) const;

  /**
   * static method to sets the visibility of a pqOutputPort
   */
  // b static void setVisibility(bool visible, pqOutputPort* port);

  /**
   * Provides access to the context menu.
   */
  // b QMenu* contextMenu() const;
...
protected: // NOLINT(readability-redundant-access-specifiers)
  ...
  // b pqPipelineModel* PipelineModel;
  // b pqPipelineAnnotationFilterModel* FilteredPipelineModel;
