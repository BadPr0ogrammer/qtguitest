...
#include "vtkCommonCoreModule2.h" // For export macro
#include "vtkObject2.h"

#include "vtkDebug2.h"             // Needed for VTK_DEBUG_LEAKS macro setting.
#include "vtkDebugLeaksManager2.h" // Needed for proper singleton initialization
