...
#else
#include "vtkIOStream2.h" // Include the real C++ streams.
#endif
...
#include "vtkWrappingHints2.h"

// this should be removed at some point
#define VTK_USE_EXECUTIVES

#define VTK_SYSTEM_INCLUDES_INSIDE
#include "vtkOStreamWrapper2.h" // Include the ostream wrapper.

#include "vtkOStrStreamWrapper2.h" // Include the ostrstream wrapper.
#undef VTK_SYSTEM_INCLUDES_INSIDE
